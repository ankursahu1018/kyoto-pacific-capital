...
const Founder = () => {
    ...
    const jpParagraphs = [
        ...
        "キャリアを通じて、30社以上の企業に対し総額40億ドル以上の投資を主導してきました。アジアにおける最も先駆的な案件を数多く手がけ、経営陣と長期的なパートナー、共同起業家として密接に協働し、単なる財務投資家としてではなく、創業者や経営幹部と肩を並べて事業運営に携わってきました。これらの投資は総額120億ドル以上の株主価値を実現し、ユニバーサル・スタジオ・ジャパン（USJ）、三洋電機、イー・アクセス、リニューパワー、ジャパン・リニューアブル・エナジーを含む5件の数十億ドル規模の成功事例を生み出しました。",
        "USJでは、13年間にわたり中心的な役割を担い、筆頭株主を代表するリード・ディレクターとして、複数フェーズにわたる変革を主導しました。CEOと共に主要な戦略的・事業運営上の意思決定を推進し、IPO主導、非公開化、資本再構成取引を主導し、経営幹部の採用、4億5000万ドル超のハリー・ポッター投資の主導、コムキャストへの最終売却交渉を実施しました。この間、年間来場者数は750万人から1,500万人以上へと倍増し、EBITDAは5倍以上に増加、最終的に数十億ドル規模のリターンを達成しました。USJ案件は、アジアにおける最も成功したプライベート・エクイティ投資の一つとして、またゴールドマン・サックスのグローバル投資の中でもトップクラスの実績として広く認識されています。",
        "キャリア初期には、パナソニック（日本）にて半導体設計およびビジネス開発に従事。この経験は、テクノロジー（ハードウェア・ソフトウェア）、製造業、異文化間での事業遂行に対する現在のアプローチの基盤となっています。",
        "ハーバード・ビジネス・スクールでMBAを取得、タフツ大学で電気工学の修士号を最優等（summa cum laude）で取得。現在、タフツ大学の理事を務め、監査・リスク・コンプライアンス委員会の委員長を担当しています。",
        "英語、日本語、ヒンディー語に堪能。YPO（日本およびパリ）の2007年以来のメンバーであり、インドの主要な戦略的フィランソロピー・プラットフォームであるDasraの理事も務めています。世界各地で生活・仕事をしながら、アジア、欧州、米国の起業家、ビジネスリーダー、各種機関と深く関わり続けています。",
    ];
    ...
    const enParagraphs = [
        ...
        "At USJ, Ankur played a central role over a 13-year period, serving as lead director representing the majority shareholder through a multi-phase transformation. Alongside the CEO, he drove major strategic and operational decisions, led the IPO, take-private, and recapitalization transactions, recruited key members of the senior management team, led the $450M+ Harry Potter investment, and negotiated the final sale to Comcast. During this time, annual visitors more than doubled from 7.5 million to over 15 million, EBITDA increased more than fivefold, and the investment ultimately generated a multi-billion-dollar return. The USJ transaction is widely regarded as one of the most successful private equity outcomes in Asia and among Goldman Sachs' top-performing global investments.",
        "Earlier in his career, Ankur worked at Panasonic in Japan, where he held roles in semiconductor design and business development. This experience continues to shape his approach to technology (hardware and software), manufacturing, and cross-cultural execution.",
        "Ankur holds an MBA from Harvard Business School and an M.S. in Electrical Engineering (summa cum laude) from Tufts University. He currently serves on the Board of Trustees of Tufts University, where he chairs the Audit, Risk, and Compliance Committee.",
        "He is fluent in English, Japanese, and Hindi. A member of YPO (Japan and Paris) since 2007, Ankur also serves on the board of Dasra, a leading strategic philanthropy platform in India. He lives and works globally, and remains deeply engaged with entrepreneurs, business leaders, and institutions across Asia, Europe, and the United States.",
    ];
    return (
        <Layout>
            <SEO
