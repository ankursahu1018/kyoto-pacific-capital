...
const Founder = () => {
    ...
    const jpParagraphs = [
        ...
        "英語、日本語、ヒンディー語に堪能。2007年よりYPO（Young Presidents' Organization）のメンバーであり、HBSジャパン同窓会の執行委員を務め、インドの主要な戦略的フィランソロピー・プラットフォームであるDasraの理事も務めています。世界各地で生活・仕事をしながら、アジア、欧州、米国の起業家、ビジネスリーダー、各種機関と深く関わり続けています。",
    ];
    ...
    const enParagraphs = [
        ...
        "He is fluent in English, Japanese, and Hindi. A member of YPO since 2007 and Executive Committee Member of the HBS Japan Alumni Association, Ankur also serves on the board of Dasra, a leading strategic philanthropy platform in India. He lives and works globally, and remains deeply engaged with entrepreneurs, business leaders, and institutions across Asia, Europe, and the United States.",
    ];
    return (
        <Layout>
            <SEO
