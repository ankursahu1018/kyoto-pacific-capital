      ...
      <section className="pb-24 min-h-screen">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-display font-normal text-gold mb-8 text-center animate-fade-up delay-300">
              Core Values
            </h2>
              ...
              {values.map((value, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-display font-normal text-gold mb-2">
                        {value.title}
                      </h3>
