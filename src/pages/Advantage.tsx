...
const advantages = [
  {
    icon: Network,
    title: "Market Access",
    description: "Deep networks across Japan and India built over decades. We open doors that matter, from customers and partners to regulators and talent.",
    details: [
              ...
              >
                <div className="flex flex-col lg:flex-row gap-8">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-2xl font-display font-normal text-gold mb-4">
                      {advantage.title}
                    </h3>
