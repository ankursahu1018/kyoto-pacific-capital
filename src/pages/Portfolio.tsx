          ...
          <div className="flex justify-center gap-4 mb-12 animate-fade-up delay-300">
            {[
              ...
              <button
                ...
                className={`px-6 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${filter === tab.value
            ...
            {filteredCompanies.map((company, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-4">
                  <h3 className="text-xl font-display font-normal text-gold">
                    {company.name}
                  </h3>
                  <span
                    className={`px-2 py-1 rounded-md text-xs font-medium ${company.status === "current"
