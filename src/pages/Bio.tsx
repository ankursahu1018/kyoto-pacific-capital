        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 mb-16">
            ...
            <div className="lg:col-span-3">
              <h1 className="text-4xl md:text-5xl font-display font-light text-gold mb-2 animate-fade-up">
                {String(t("bio.title"))}
              </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <GlassCard className="p-8 animate-fade-up">
              <h2 className="text-xl font-display font-light text-gold mb-4">
          ...
          <div className="mb-16 animate-fade-up">
            <h2 className="text-sm uppercase tracking-widest text-gold mb-6 text-center">
              {String(t("bio.press"))}
            </h2>
